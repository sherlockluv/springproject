		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" action="modifyPage" method="post">
					...
					<input type='hidden' name='bno' value="${questionVO.bno}">
				...
				<div class="box-body">
					<div class="form-group">
						<label for="exampleInputEmail1">Title</label> <input type="text"
							name='title' class="form-control" value="${questionVO.title}"
							readonly="readonly">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">Writer</label> <input type="text"
							name="writer" class="form-control" value="${questionVO.writer}"
							readonly="readonly">
					</div>
					
					<div>
					<input type="hidden" name="b_pwd" class="fomr-control" value="${questionVO.b_pwd}" readonly="readonly">
					</div>
				</div>
				<!-- /.box-body -->
				<div class="box-footer">
					<ul class="mailbox-attachments clearfix uploadedList"></ul>
						<c:if test="${login.name eq questionVO.writer}">
